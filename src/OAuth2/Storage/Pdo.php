    ...
    OpenIDAuthorizationCodeInterface
{
    ...
    public function setUser($username, $password, $firstName = null, $lastName = null)
    {
        ...
        if ($this->getUser($username)) {
            $stmt = $this->db->prepare($sql = sprintf('UPDATE %s SET passwd=:password, forename=:firstName, surname=:lastName where email=:username', $this->config['user_table']));
        } else {
            $stmt = $this->db->prepare(sprintf('INSERT INTO %s (email, passwd, forename, surname) VALUES (:username, :password, :firstName, :lastName)', $this->config['user_table']));
        }
